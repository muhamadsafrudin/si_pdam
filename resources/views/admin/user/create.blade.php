          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-sm-7">
                  <form action="{{ url('admin/user/store') }}" method="POST" class="row">
                    @csrf
                      <div class="form-group col-sm-8">
                        <label for="">Nama user *</label>
                        <input class="form-control @error('nama') is-invalid  @enderror" type="text" value="{{ old('nama') }}" name="nama" placeholder="nama user..">
                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <input class="form-control @error('email') is-invalid  @enderror" type="email" value="{{ old('email') }}" name="email" placeholder="email user..">
